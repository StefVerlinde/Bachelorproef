...
\section{\IfLanguageName{dutch}{JWT Bearer token authenticatie}{JWT Bearer token authentication}}
...
\begin{table}[H]
	...
	\begin{tabular}{lcr}
		...
		nonce          & String                & \begin{tabular}[c]{@{}r@{}}Een unieke identificatie die wordt gebruikt om te beschermen \\ tegen replay attacks. De resource kan deze waarde \\ registreren om te beschermen tegen herhalingen.\end{tabular} \\ \hline
		alg            & String                & \begin{tabular}[c]{@{}r@{}}Geeft het algoritme aan dat is gebruikt om \\ de token te ondertekenen, bijvoorbeeld RS256.\end{tabular}                                                                        \\ \hline
		kid            & String                & \begin{tabular}[c]{@{}r@{}}Specificeert de vingerafdruk voor de openbare sleutel \\ die wordt gebruikt om dit token te ondertekenen.\end{tabular}                                                            \\ \hline
...
\begin{tabular}{lcl}
	...
	iat            & \begin{tabular}[c]{@{}c@{}}int, een \\ UNIX\\ tijdstip\end{tabular}                      & \begin{tabular}[c]{@{}l@{}}"Issued At" geeft aan wanneer de authenticatie voor deze token \\ heeft plaatsgevonden.\end{tabular}                                                                                                                                                                                                                                                                                                            \\ \hline
	...
	appid          & \begin{tabular}[c]{@{}c@{}}String, een\\ GUID\end{tabular}                               & \begin{tabular}[c]{@{}l@{}}De application-ID van de client die het token gebruikt. \\ De applicatie kan als zichzelf of namens een gebruiker optreden.\end{tabular}                                                                                                                                                                                                                                                                        \\ \hline
	appidacr       & 0, 1 of 2                                                                                & \begin{tabular}[c]{@{}l@{}}Geeft aan hoe de client is geverifieerd. Voor een openbare \\ client is de waarde "0". Als client-ID en client secret worden \\ gebruikt, is de waarde "1". Als een client certificate is gebruikt \\ voor authenticatie, is de waarde "2".\end{tabular}                                                                                                                                                        \\ \hline
...
\begin{figure}[H]
	...
	\label{fig:pocfinal2}
\end{figure}
\section{\IfLanguageName{dutch}{Proof of concept met password grant type}{Proof of concept with password grant type}}
